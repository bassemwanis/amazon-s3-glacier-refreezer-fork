            ...
            "Properties": {
                "DefinitionString": assertions.Match.string_like_regexp(
                    (
                        ...
                        r'"GenerateChunkArrayLambda":{"Type":"Pass","Parameters":{"chunk_array":\["\d+-\d+"(,+"\d+-\d+")+\]},"Next":"ChunksDistributedMap"},'
                        r'"ChunksDistributedMap":{"Next":"GlueOrderArchives","Type":"Map",'
                        r'"ItemProcessor":{"ProcessorConfig":{"Mode":"DISTRIBUTED","ExecutionType":"STANDARD"},'
                        r'"StartAt":"InventoryChunkDownloadLambda","States":{"InventoryChunkDownloadLambda":{"Type":"Pass","Parameters":{"InventoryRetrieved":"TRUE"},"End":true}}},'
                        r'"MaxConcurrency":\d+,"ItemsPath":"\$.chunk_array"},'
